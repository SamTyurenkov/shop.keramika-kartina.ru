...
function virtue_woocommerce_archive_hooks() {
	 ...
	 */
	function virtue_get_product_class( $class = null ) {
	 ...
	 * @param mixed $class the added classes.
	 */
	function virtue_product_class( $class = null ) {
		echo 'class="' . esc_attr( join( ' ', apply_filters( 'virtue_product_loop_classes', virtue_get_product_class( $class ) ) ) ) . '"';
	}
	/**
	 * Woocommerce_before_shop_loop_item
	 */
