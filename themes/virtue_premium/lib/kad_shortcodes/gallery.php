...
if ( empty( $caption ) || 'default' == $caption ) {
...
ob_start(); ?>
  ...
  <?php  $output = ob_get_contents();
    ob_end_clean();
		...
		$images = implode( ',', $images );
		virtue_build_slider( $gallery_id, $images, $width, $height, 'image', 'kt-gallery-slider kt-slider-same-image-ratio', 'slider', $caption, $autoplay, $speed, $arrows, $fade, $transpeed );
