...
global $post, $virtue_premium; 
    ...
    if($postsummery == 'img_landscape') { ?>
        <div id="post-<?php the_ID(); ?>" class="blog_item kt_item_fade_in grid_item" itemscope="" itemtype="https://schema.org/BlogPosting">
				<?php
				$img_args = array(
					'width'           => 562,
					'height'          => $image_height,
        ...
        <div id="post-<?php the_ID(); ?>" class="blog_item grid_item kt_item_fade_in portrait-grid" itemscope="" itemtype="https://schema.org/BlogPosting">
            <div class="rowtight">
			<?php 
			$img_args = array(
				'width'           => 364,
		...
		<div id="post-<?php the_ID(); ?>" class="blog_item kt_item_fade_in grid_item portrait-grid" itemscope="" itemtype="https://schema.org/BlogPosting">
			<div class="rowtight">
    ...
    <?php 
		...
		<div id="post-<?php the_ID(); ?>" class="blog_item kt_item_fade_in grid_item kt-no-post-summary" itemscope="" itemtype="https://schema.org/BlogPosting">
    <?php 
    } 
