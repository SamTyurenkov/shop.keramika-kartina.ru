...
?>
<article id="post-<?php the_ID(); ?>" <?php post_class('kad_blog_item kad-animation'); ?> data-animation="fade-in" data-delay="0" itemscope itemtype="https://schema.org/BlogPosting">
     <div class="row">
          <?php 
