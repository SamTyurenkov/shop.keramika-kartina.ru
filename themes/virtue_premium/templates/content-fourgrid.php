<?php 
    ...
    if ( 'img_landscape' == $postsummery || 'img_portrait' == $postsummery ) {
        ...
        <div id="post-<?php the_ID(); ?>" class="blog_item kt_item_fade_in kad_blog_fade_in grid_item" itemscope="" itemtype="https://schema.org/BlogPosting">
    ...
    <?php 
        ...
        <div id="post-<?php the_ID(); ?>" class="blog_item kt_item_fade_in kad_blog_fade_in grid_item kt-no-post-summary" itemscope="" itemtype="https://schema.org/BlogPosting">
    <?php } ?>
