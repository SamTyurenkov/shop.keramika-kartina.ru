    ...
    <table class="items-table <?php echo $post_type; ?>" cellpadding="0" cellspacing="0">
        <thead>
            <tr class="items-list-header">
                <?php
                if ( 'on' == $featured_img ) {
                    echo '<th class="wpuf_table_featured">' . __( 'Featured Image', 'wpuf' ) . '</th>';
                }
                ?>
                <th class="wpuf_table_title"><?php _e( 'Title', 'wpuf' ); ?></th>
                <th class="wpuf_table_status"><?php _e( 'Status', 'wpuf' ); ?></th>
                ...
                ?>
                <th class="wpuf_table_options"><?php _e( 'Options', 'wpuf' ); ?></th>
            </tr>
        </thead>
        <tbody>
            <?php
