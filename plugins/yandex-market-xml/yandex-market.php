...
<?
echo '<shop>
 <name>Школа Массажа</name>
 <company>ИП Крымова</company>
 <url>https://apanties.ru</url>
 <currencies>
...
$objects = new WP_Query(array('post_type' => 'product_variation',
											 'post_status' => 'publish',
											 'posts_per_page' => -1,
									));
...
$category = '1';
?>
<offer id="<?= get_the_ID(); ?>" available="true">
<name>
...
<picture><?  echo get_the_post_thumbnail_url(); ?></picture>
<pickup>true</pickup>
<description>
<![CDATA[
<? echo str_replace('<br>','<p>- - - - - - - - - - -</p>', str_replace(array("'", "\"", "&quot;", "&#8212;", "&nbsp;", "&#171;", "&#187;"), '', $product->get_description())); ?>
]]>
</description>
...
<g:price><? $product_id = get_the_ID();$product = wc_get_product( $product_id ); ?><?=$product->get_sale_price(); ?> RUB</g:price>
<g:availability>in stock</g:availability>
<g:image_link><?  echo get_the_post_thumbnail_url(); ?></g:image_link>
<description>
<![CDATA[
<? echo str_replace(array("'", "\"", "&quot;", "&#8212;", "&nbsp;", "&#171;", "&#187;"), '', $product->get_description()); ?>
]]>
</description>
</item>
<? endwhile; wp_reset_postdata(); ?>
