...
if ( ! class_exists( 'Woodev_License_Settings' ) ) :
	...
	class Woodev_License_Settings {
		...
		public function set_wc_screen_ids( $screen ) {
			return array_merge( $screen, array( Woodev_Helper::get_current_screen()->id ) );
		}
		...
		public function register_license_settings() {
			...
			add_settings_field(
				...
				array( $this, 'do_license_fields' ),
				'woodev_licenses_page',
				'woodev_licenses_section',
				array( 'class' => 'license-container' )
			);
			...
			register_setting( 'woodev_license_fields_group', $license_key_option_name, function ( $input ) {
				...
				if ( isset( $_REQUEST[ $beta_version ] ) && 'yes' == $_REQUEST[ $beta_version ] ) {
		...
		public function do_license_fields() {
			...
			$message_classes = array( 'woodev-licenses-data' );
