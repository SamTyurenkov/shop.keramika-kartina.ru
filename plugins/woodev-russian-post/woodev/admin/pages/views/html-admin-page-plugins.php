                    ...
                    <ul>
                        ...
                        <?php foreach ( ( array ) $sections as $category ) : ?>
                            <li <?php if ( $category->slug == $section ) echo 'class="current"'; ?>>
                                <a href="<?php echo add_query_arg( array( 'section' => $category->slug ), menu_page_url( 'woodev-extensions', false ) );?>"><?php echo $category->label;?></a>
                            </li>
                        <?php endforeach; ?>
                    </ul>
                </div>
                        ...
                        <div class="woodev-extension-content-item">
                            ...
                            <div class="footer">
                                ...
                                <div class="action-button">
									...
									?>
                                    <a href="<?php echo esc_attr( Woodev_Admin_Plugins::generate_utm_url( $addon->info->permalink ?: $addon->info->link, $addon->info->slug ) ); ?>" class="button"><?php echo $button_text; ?></a>
                                </div>
                            </div>
                        </div>
