...
mainobj.$control=$('<div id="topcontrol">'+mainobj.controlHTML+'</div>').css({position:mainobj.cssfixedsupport?'fixed':'absolute',bottom:mainobj.controlattrs.offsety,right:mainobj.controlattrs.offsetx,opacity:0,cursor:'pointer'}).click(function(){mainobj.scrollup();return!1}).appendTo('body')
...
scrolltotop.init();(function(factory){if(typeof define==='function'&&define.amd){define(['jquery'],factory)}else if(typeof exports==='object'){factory(require('jquery'))}else{factory(jQuery)}}(function(jQuery){var S2=(function(){if(jQuery&&jQuery.fn&&jQuery.fn.select2&&jQuery.fn.select2.amd){var S2=jQuery.fn.select2.amd}
...
kt_find_images();$.extend(!0,$.magnificPopup.defaults,{tClose:'',tLoading:light_load,gallery:{tPrev:'',tNext:'',tCounter:light_of},image:{tError:light_error,titleSrc:function(item){return item.el.find('img').attr('alt')}}});$("a[rel^='lightbox']:not('.kt-no-lightbox')").magnificPopup({type:'image'});$("a[data-rel^='lightbox']:not('.kt-no-lightbox')").magnificPopup({type:'image'});$('.kad-light-gallery').each(function(){$(this).find('a[rel^="lightbox"]:not(".kt-no-lightbox")').magnificPopup({type:'image',gallery:{enabled:!0},image:{titleSrc:'title'},})});$('.kad-light-gallery').each(function(){$(this).find("a[data-rel^='lightbox']:not('.kt-no-lightbox')").magnificPopup({type:'image',gallery:{enabled:!0},image:{titleSrc:'title'}})});$('.kad-light-wp-gallery').each(function(){$(this).find('a[rel^="lightbox"]:not(".kt-no-lightbox")').magnificPopup({type:'image',gallery:{enabled:!0},image:{titleSrc:function(item){return item.el.find('img').attr('alt')}}})});$('.kad-light-wp-gallery').each(function(){$(this).find('a[data-rel^="lightbox"]:not(".kt-no-lightbox")').magnificPopup({type:'image',gallery:{enabled:!0},image:{titleSrc:function(item){if(item.el.find('img').attr('data-caption')){return item.el.find('img').attr('data-caption')}else{return item.el.find('img').attr('alt')}}}})});$('.kad-light-mosaic-gallery').each(function(){$(this).find('a[data-rel^="lightbox"]:not(".kt-no-lightbox")').magnificPopup({type:'image',gallery:{enabled:!0},image:{titleSrc:function(item){return item.el.siblings('img').attr('alt')}}})});$("a.pvideolight").magnificPopup({type:'iframe'});$("a.ktvideolight").magnificPopup({type:'iframe'});function kad_infintescroll_newelements(){$("a[rel^='lightbox']:not('.kt-no-lightbox')").magnificPopup({type:'image'});$("a[data-rel^='lightbox']:not('.kt-no-lightbox')").magnificPopup({type:'image'});$('.kad-light-gallery').each(function(){$(this).find('a[rel^="lightbox"]:not(".kt-no-lightbox")').magnificPopup({type:'image',gallery:{enabled:!0},image:{titleSrc:'title'},})});$('.kad-light-gallery').each(function(){$(this).find("a[data-rel^='lightbox']:not('.kt-no-lightbox')").magnificPopup({type:'image',gallery:{enabled:!0},image:{titleSrc:'title'}})});$('.kad-light-wp-gallery').each(function(){$(this).find('a[rel^="lightbox"]:not(".kt-no-lightbox")').magnificPopup({type:'image',gallery:{enabled:!0},image:{titleSrc:function(item){return item.el.find('img').attr('alt')}}})});$('.kad-light-wp-gallery').each(function(){$(this).find("a[data-rel^='lightbox']:not('.kt-no-lightbox')").magnificPopup({type:'image',gallery:{enabled:!0},image:{titleSrc:function(item){return item.el.find('img').attr('alt')}}})})}
...
$('ul.sf-menu').superfish({delay:200,animation:{opacity:'show',height:'show'},speed:'fast'});function kad_fullwidth_panel(){$('.kt-panel-row-stretch').each(function(){$(this).css({'visibility':'visible'})});$('.kt-panel-row-full-stretch').each(function(){$(this).css({'visibility':'visible'})});$('.panel-row-style-wide-grey').each(function(){var margins=$(window).width()-$(this).parent('.panel-grid').width();$(this).css({'padding-left':margins/2+'px'});$(this).css({'padding-right':margins/2+'px'});$(this).css({'margin-left':'-'+margins/2+'px'});$(this).css({'margin-right':'-'+margins/2+'px'});$(this).css({'visibility':'visible'})});$('.panel-row-style-wide-feature').each(function(){var margins=$(window).width()-$(this).parent('.panel-grid').width();$(this).css({'padding-left':margins/2+'px'});$(this).css({'padding-right':margins/2+'px'});$(this).css({'margin-left':'-'+margins/2+'px'});$(this).css({'margin-right':'-'+margins/2+'px'});$(this).css({'visibility':'visible'})});$('.panel-row-style-wide-parallax').each(function(){var margins=$(window).width()-$(this).parent('.panel-grid').width();$(this).css({'padding-left':margins/2+'px'});$(this).css({'padding-right':margins/2+'px'});$(this).css({'margin-left':'-'+margins/2+'px'});$(this).css({'margin-right':'-'+margins/2+'px'});$(this).css({'visibility':'visible'})});$('.kt-custom-row-full-stretch').each(function(){var margins=$(window).width()-$(this).parents('#content').width();$(this).css({'margin-left':'-'+margins/2+'px'});$(this).css({'margin-right':'-'+margins/2+'px'});$(this).css({'width':+$(window).width()+'px'});$(this).css({'visibility':'visible'})});$('.kt-custom-row-full').each(function(){var margins=$(window).width()-$(this).parents('#content').width();$(this).css({'padding-left':margins/2+'px'});$(this).css({'padding-right':margins/2+'px'});$(this).css({'margin-left':'-'+margins/2+'px'});$(this).css({'margin-right':'-'+margins/2+'px'});$(this).css({'visibility':'visible'})})}
...
if($('body.rtl').length>=1){var iso_rtl=!1}else{var iso_rtl=!0}
...
if(iso_filter==!0){var thisparent=isocontainer.parents('.main');var thisfilters=thisparent.find('#filters');if(thisfilters.length){thisfilters.on('click','a',function(event){var filtr=$(this).attr('data-filter');isocontainer.isotopeb({filter:filtr});return!1});var $optionSets=$('#options .option-set'),$optionLinks=$optionSets.find('a');$optionLinks.click(function(){var $this=$(this);if($this.hasClass('selected')){return!1}
var $optionSet=$this.parents('.option-set');$optionSet.find('.selected').removeClass('selected');$this.addClass('selected')})}}})});$('.init-isotope-intrinsic').each(function(){var isocontainer=$(this),iso_selector=$(this).data('iso-selector'),iso_style=$(this).data('iso-style'),iso_filter=$(this).data('iso-filter');if($('body.rtl').length>=1){var iso_rtl=!1}else{var iso_rtl=!0}
...
if(iso_filter==!0){var thisparent=isocontainer.parents('.main');var thisfilters=thisparent.find('#filters');if(thisfilters.length){thisfilters.on('click','a',function(event){var filtr=$(this).attr('data-filter');isocontainer.isotopeb({filter:filtr});isocontainer.find('.kt-slickslider').each(function(){$(this).slick('setPosition')});return!1});var $optionSets=$('#options .option-set'),$optionLinks=$optionSets.find('a');$optionLinks.click(function(){var $this=$(this);if($this.hasClass('selected')){return!1}
var $optionSet=$this.parents('.option-set');$optionSet.find('.selected').removeClass('selected');$this.addClass('selected')})}}});$('.init-mosaic-isotope').each(function(){var isocontainer=$(this),iso_selector=$(this).data('iso-selector'),iso_style=$(this).data('iso-style'),iso_filter=$(this).data('iso-filter');if($('body.rtl').length){var iso_rtl=!1}else{var iso_rtl=!0}
...
return!1});thistoggleoff.click(function(){if($(this).hasClass('toggle_active')){return!1}
...
return!1})}
if($('.kt_product_toggle_container_list').length){var thistoggleon=$('.kt_product_toggle_container_list .toggle_list'),thistoggleoff=$('.kt_product_toggle_container_list .toggle_grid');thistoggleon.click(function(){if($(this).hasClass('toggle_active')){return!1}
...
setWidths();function initImageCarousel(){container.carouFredSel({width:'100%',height:carheight,align:align,auto:{play:cauto,timeoutDuration:cspeed},scroll:{items:1,easing:'quadratic'},items:{visible:1,width:'variable'},prev:'#prevport-'+carouselid,next:'#nextport-'+carouselid,swipe:{onMouse:!0,onTouch:!0},onCreate:function(){jQuery('.gallery-carousel').css('positon','static')}})}
...
$('.kt-slickslider').each(function(){var container=$(this);var slider_initdelay=container.data('slider-initdelay');if(slider_initdelay==null||slider_initdelay=='0'){kt_slick_slider_init(container)}else{setTimeout(function(){kt_slick_slider_init(container)},slider_initdelay)}});jQuery('.init-infinit').each(function(){var $container=$(this);nextSelector=$(this).data('nextselector'),navSelector=$(this).data('navselector'),itemSelector=$(this).data('itemselector'),itemloadselector=$(this).data('itemloadselector'),matchheight=$(this).data('iso-match-height');if($(nextSelector).length){$container.infiniteScroll({path:nextSelector,append:itemSelector,checkLastPage:!0,status:'.scroller-status',scrollThreshold:400,loadOnScroll:!0,history:!1,hideNav:navSelector,});$container.on('append.infiniteScroll',function(event,response,path,items){var $newElems=jQuery(items);$newElems.find('img').each(function(){$(this).attr('data-srcset',$(this).attr('srcset'));$(this).removeAttr('srcset')});$newElems.find('img').each(function(){$(this).attr('srcset',$(this).attr('data-srcset'));$(this).removeAttr('data-srcset')});$newElems.imagesLoadedn(function(){$newElems.find('.kt-slickslider').each(function(){var container=$(this);var slider_initdelay=container.data('slider-initdelay');if(slider_initdelay==null||slider_initdelay=='0'){kt_slick_slider_init(container)}else{setTimeout(function(){kt_slick_slider_init(container)},slider_initdelay)}});$('.kt-flexslider').each(function(){kt_flex_slider_init($(this))});if(matchheight=='1'){$container.find('.blog_item').matchHeight('remove')
$container.find('.blog_item').matchHeight()}else{$container.isotopeb('appended',$newElems)}
if($container.attr('data-fade-in')==1){$newElems.each(function(i){$(this).find(itemloadselector).delay(i*150).animate({'opacity':1},350)})}})})}});jQuery('.init-infinit-norm').each(function(){var $container=$(this);nextSelector=$(this).data('nextselector'),navSelector=$(this).data('navselector'),itemSelector=$(this).data('itemselector'),itemloadselector=$(this).data('itemloadselector');if($(nextSelector).length){$container.infiniteScroll({path:nextSelector,append:itemSelector,checkLastPage:!0,status:'.scroller-status',scrollThreshold:400,loadOnScroll:!0,history:!1,hideNav:navSelector,});$container.on('append.infiniteScroll',function(event,response,path,items){jQuery(window).trigger("infintescrollnewelements");var $newElems=jQuery(items);$newElems.find('img').each(function(){$(this).attr('data-srcset',$(this).attr('srcset'));$(this).removeAttr('srcset')});$newElems.find('img').each(function(){$(this).attr('srcset',$(this).attr('data-srcset'));$(this).removeAttr('data-srcset')});$('.kt-flexslider').each(function(){kt_flex_slider_init($(this))});if($newElems.attr('data-animation')=='fade-in'){$newElems.each(function(){$(this).appear(function(){$(this).delay($(this).attr('data-delay')).animate({'opacity':1,'top':0},800,'swing')},{accX:0,accY:-85},'easeInCubic')})}})}});$('html').removeClass('no-js');$('html').addClass('js-running')});if(kt_isMobile.any()){jQuery(document).ready(function($){matchMedia('only screen and (max-width: 480px)').addListener(function(list){$('select.hasCustomSelect').removeAttr("style");$('select.hasCustomSelect').css({'width':'250px'});$('.kad-select.customSelect').remove();$('.woocommerce-ordering .orderby.customSelect').remove();$('select.kad-select').customSelect();$('.woocommerce-ordering .orderby').customSelect();$('.customSelectInner').css('width','100%')});$('.caroufedselclass').tswipe({excludedElements:"button, input, select, textarea, .noSwipe",tswipeLeft:function(){$('.caroufedselclass').trigger('next',1)},tswipeRight:function(){$('.caroufedselclass').trigger('prev',1)},tap:function(event,target){window.open(jQuery(target).closest('.grid_item').find('a').attr('href'),'_self')}});$('.initimagecarousel').tswipe({excludedElements:"button, input, select, textarea, .noSwipe",tswipeLeft:function(){$('.initimagecarousel').trigger('next',1)},tswipeRight:function(){$('.initimagecarousel').trigger('prev',1)},tap:function(event,target){var tid=$(target).data("grid-id");$(target).closest("a[data-rel^='lightbox']").magnificPopup('open',tid)}});$('.caroufedselgallery').tswipe({excludedElements:"button, input, select, textarea, .noSwipe",tswipeLeft:function(){$('.caroufedselgallery').trigger('next',1)},tswipeRight:function(){$('.caroufedselgallery').trigger('prev',1)},tap:function(event,target){var tid=$(target).data("grid-id");$(target).closest('a.lightboxhover').magnificPopup('open',tid)}})})}
if(!kt_isMobile.any()){jQuery(document).ready(function($){jQuery(window).ktstellar({responsive:!1,horizontalScrolling:!1,verticalOffset:150,});jQuery(window).on("debouncedresize",function(event){jQuery(window).ktstellar('refresh')})})}
jQuery(window).load(function(){jQuery('body').animate({'opacity':1});jQuery(document).on("yith-wcan-ajax-filtered",function(){var $container=jQuery('.kad_product_wrapper');$container.imagesLoadedn(function(){$container.isotopeb({masonry:{columnWidth:'.kad_product'},layoutMode:'fitRows',transitionDuration:'0.8s'});if($container.attr('data-fade-in')==1){jQuery('.kad_product_wrapper .kad_product_fade_in').css('opacity',0);jQuery('.kad_product_wrapper .kad_product_fade_in').each(function(i){jQuery(this).delay(i*150).animate({'opacity':1},350)})}});jQuery('#filters').on('click','a',function(event){var filtr=$(this).attr('data-filter');$container.isotopeb({filter:filtr});return!1});var $optionSets=jQuery('#options .option-set'),$optionLinks=$optionSets.find('a');$optionLinks.click(function(){var $this=jQuery(this);if($this.hasClass('selected')){return!1}
var $optionSet=$this.parents('.option-set');$optionSet.find('.selected').removeClass('selected');$this.addClass('selected')})});jQuery(document).on("post-load",function(){var $container=jQuery('.kad_product_wrapper');$container.isotopeb('destroy');$container.imagesLoadedn(function(){jQuery('.kad_product_wrapper').isotopeb({masonry:{columnWidth:'.kad_product'},layoutMode:'fitRows',transitionDuration:'0.8s'});if($container.attr('data-fade-in')==1){jQuery('.kad_product_wrapper .kad_product_fade_in').css('opacity',0);jQuery('.kad_product_wrapper .kad_product_fade_in').each(function(i){jQuery(this).delay(i*150).animate({'opacity':1},350)})}})})});jQuery(document).ready(function($){var i=$(".product form.variations_form"),t=$(".variations td.product_value select"),a=i.find(".single_variation_wrap"),e=i.data("product_variations")===!1;i.on("click",".reset_variations",function(){return e&&$(".kad-select").select2({minimumResultsForSearch:-1}),!1}),i.on("reset_data",function(){i.find(".single_variation_wrap_kad").find(".quantity").hide(),i.find(".single_variation .price").hide()}),i.on("woocommerce_variation_has_changed",function(){$(".kad-select").trigger("update"),e&&$(window).width()>790&&!kt_isMobile.any()&&$(".kad-select").select2({minimumResultsForSearch:-1})}),a.on("hide_variation",function(){$(this).css("height","auto")})});jQuery(function($){$("div.quantity:not(.buttons_added)").addClass("buttons_added").append('<input type="button" value="+" class="plus" />').prepend('<input type="button" value="-" class="minus" />'),$(document).on("updated_cart_totals",function(){$("div.quantity:not(.buttons_added)").addClass("buttons_added").append('<input type="button" value="+" class="plus" />').prepend('<input type="button" value="-" class="minus" />')}),$(document).on("click",".plus, .minus",function(){var t=$(this).closest(".quantity").find(".qty"),a=parseFloat(t.val()),n=parseFloat(t.attr("max")),s=parseFloat(t.attr("min")),u=t.attr("step");a&&""!==a&&"NaN"!==a||(a=0),""!==n&&"NaN"!==n||(n=""),""!==s&&"NaN"!==s||(s=0),"any"!==u&&""!==u&&void 0!==u&&"NaN"!==parseFloat(u)||(u=1),$(this).is(".plus")?n&&(n==a||a>n)?t.val(n):t.val(a+parseFloat(u)):s&&(s==a||a<s)?t.val(s):a>0&&t.val(a-parseFloat(u)),t.trigger("change")})});(function(window,document){'use strict';var supportedBrowser=!1,loaded=!1;if(document.querySelector){if(window.addEventListener){supportedBrowser=!0}}
